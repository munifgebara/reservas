...
import br.com.gumga.reservas.application.service.RecursoService;
...
public class RecursoAPI extends GumgaAPI<Recurso, Long> {


    @Autowired
    public RecursoAPI(GumgaService<Recurso, Long> service) {
        super(service);
    }
