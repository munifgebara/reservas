...
import br.com.gumga.reservas.application.service.ColaboradorService;
...
public class ColaboradorAPI extends GumgaAPI<Colaborador, Long> {


    @Autowired
    public ColaboradorAPI(GumgaService<Colaborador, Long> service) {
        super(service);
    }
